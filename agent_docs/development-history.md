...
- **Число SNP — РАЗРЕШЕНО (перечитыванием первоисточника):** блоки 1–4 сходятся точно как уникальные (51/28/27/12). Расхождение только в блоке 5: его фармакогенетические колонки = 122 записи → 103 уникальных (один SNP читается ради нескольких лекарств и считается несколько раз) + 18 усилителей из блоков 1–4 → её 146; декомпозиция 51+22+15+9+128 = 225. Вывод: «225» — легитимные «аналитические ген-точки по контекстам» (продуктовая величина), «184» — уникальные физические SNP (инженерная). Не ошибка, докомплект не нужен. Модуль = 184; БД/маркетинг = числа Галины (146/225). См. ADR-003.
