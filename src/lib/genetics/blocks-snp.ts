 ...
 *
 * Owner decision (2026-05-31): на витрине и в БД используем честные уникальные
 * числа (184/103); 225/146 Галины задокументированы как авторский счёт по
 * контекстам, но НЕ отображаются.
 */
...
export const BLOCKS_SNP: BlockSnp[] = [
  ...
  },
  {
    ...
    // Owner decision (2026-05-31): витрина и БД показывают 103 (уникальные).
    snps: [
